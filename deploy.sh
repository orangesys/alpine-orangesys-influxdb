...
for path in $dockerfiles; do
  ...
  docker tag "orangesys/alpine-orangesys-influxdb:${tag}" "asia.gcr.io/orange-sys/alpine-orangesys-influxdb:${tag}"
  sudo /opt/google-cloud-sdk/bin/gcloud docker push asia.gcr.io/orange-sys/alpine-orangesys-orangesys-influxdb:${tag}
